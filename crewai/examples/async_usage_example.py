...
Requirements:
    ...
    - mellea-contribs-crewai installed
...
async def main():
    ...
    researcher = Agent(
        ...
        backstory=(
            "You are an expert AI researcher who can quickly analyze and summarize complex topics."
        ),
        llm=llm,
        verbose=True,
    )
    ...
    analyst = Agent(
        ...
        backstory=(
            "You are a skilled data analyst who can identify patterns and trends in information."
        ),
        llm=llm,
        verbose=True,
    )
