"""Prompt templates for KG-RAG generative functions.

Each constant is the full docstring / prompt template consumed by
``@generative``.  Keeping prompts here makes ``generative.py`` easier to
read and allows prompts to be updated independently of function signatures.
"""
